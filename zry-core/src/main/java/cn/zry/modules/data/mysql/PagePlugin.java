...
import cn.zry.modules.data.Page;
import cn.zry.modules.data.jdbc.SQLBuilder;
import cn.zry.modules.data.jdbc.SQLBuilderFactory;
import cn.zry.modules.util.ReflectionUtils;
...
public class PagePlugin implements Interceptor {
    ...
    /**
     * 读取配置文件，不知道效果如何。推荐使用 setter 方法  ----lyf
     */
    @Override
    @Deprecated
